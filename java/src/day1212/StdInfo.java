...
public class StdInfo extends Frame{
	...
	public StdInfo() {
		...
		// 이벤트 등록 has a 관계
		StdInfoEvt sie = new StdInfoEvt(this);
		// 컴포넌트에 이벤트를 등록
		btnAdd.addActionListener(sie);
		btnDel.addActionListener(sie);
		btnUpdate.addActionListener(sie);
		btnExit.addActionListener(sie);
		listData.addItemListener(sie);
