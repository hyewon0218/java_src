...
<div id="wrap">
   ...
   <div id="container">
		<form action="jstl_choose.jsp">
			...
			<input type="submit" value="혈액형선택" class="btn">
		</form>
		<div>
		<!--여러조건비교  -->
			<c:choose>
  ...
  <%--  <%
   ...
   <div style="width: 500px; height: 200px; overflow: auto; border: 1px solid #333; ">
   		...
   		<span class="${tooltipId }"  title="회원관리, 관리자 관리 담당">김정운</span>,
   		<span class="${tooltipId }"  title="상품관리">김민정</span>,
   		<span class="${tooltipId }"  title="주문, 통계 담당">박은영</span>,
   		<span class="${tooltipId }"  title="회원조회, 요금제조회, 마일리지 담당">백인재</span>,
   		<span class="${tooltipId }"  title="로그인,회원관리 담당,요금충전 담당">정택성</span>으로 구성되어 있습니다.
   		PC방 프로그램을 완벽하게 구현하기 위해서 조장 이하 모든 조원이 합심하여 PC방으로 전격 출근하였습니다.
   </div>
