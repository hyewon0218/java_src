...
/**
 * 도시락 테이블에서 선택된 도시락의 상세 정보를 출력하고 수정, 삭제를 할 수있는 창
 * @author SIST
 */
...
public class LunchDetailView extends JDialog{
	...
	public LunchDetailView(LunchMainView lmv,LunchDetailVO ldvo, LunchMainController lmc) {
		super(lmv,"도시락 상세정보페이지",true);//모달
		//db에서 조회한 결과를컴포넌트에 채운다,
		ImageIcon ilLunch=new ImageIcon("C:/dev/workspace/lunch_prj/src/kr/co/sist/lunch/admin/img/"+ldvo.getImg());
		...
		jtfLunchName.setText(ldvo.getName());
...
//			private JTextArea jtaLunchSpec;
		 jbUpdate.setBounds(250, 360, 80, 30);
		 jbDelete.setBounds(340, 360, 80, 30);
		 jbEnd.setBounds(430, 360, 80, 30);
