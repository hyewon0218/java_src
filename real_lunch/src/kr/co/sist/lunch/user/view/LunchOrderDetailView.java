...
public class LunchOrderDetailView extends JDialog{
	...
	public LunchOrderDetailView(LunchClientView lcv, LunchDetailVO ldvo) {
		...
		jlRequest.setBounds(10, 290, 80, 25);
		...
		jspRequest.setBounds(30, 320, 220, 70);
		...
		LunchOrderDetailController lodc
				=new LunchOrderDetailController(this, ldvo.getLunchCode() );
