...
public class PopupBody extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PrintWriter out=response.getWriter();
	      ...
	      if(!popupFlag) {
	      out.println("\twindow.open('day0305/popup.html','popup','width=725,height=550,top=100,left=250')");
	      }//end if
	      out.println("}//onload");
	      out.println("</script>");
	      out.write("</head>\r\n");
	      ...
	      out.println("<h2>정윤이의 철권세상에 오셨습니다.</h2>");
	      out.println("<img src='common/images/img.png' title='게임은 수업시간에 해야 제맛!'><br/>");
	      out.println("<h3>이번주 정모는 강남역 지하 게임 센터에서 화요일 19:00부터 진행됩니다.</h3>");
