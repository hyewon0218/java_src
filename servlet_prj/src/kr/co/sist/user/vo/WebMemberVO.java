...
public class WebMemberVO {
	private String id,pass,name,ssn,gender,birth,age,marriage,marriage_date,zipcode,addr1,addr2,	greeting,ip_address;
	private String[] lang;
	...
	public String toString() {
		return "WebMemberVO [id=" + id + ", pass=" + pass + ", name=" + name + ", ssn=" + ssn + ", gender=" + gender
				...
				+ ", input_date=" + ", ip_address=" + ip_address + ", lang=" + Arrays.toString(lang) + "]";
	}
