   ...
   <div id="container">
	<div>
		...
		<%-- <c:forEach var="cookie" items="${rCookie }">
			쿠키명 : <c:out value="${cookie.name }"></c:out><br/>
			쿠키값 : <c:out value="${cookie.value }"></c:out><br/>
		</c:forEach> --%>
		<%
		...
		<c:out value="${requestScope.name }" escapeXml="false"></c:out><br/>
		태어난 해 <c:out value="${requestScope.birth }"></c:out>
