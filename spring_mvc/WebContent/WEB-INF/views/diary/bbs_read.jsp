...
<div id="wrap">
 ...
 <table id="readTab">
        ...
        <tr>
                ...
                <td style="width: 400px;"><div id="subject"><strong>${searchData.subject }</strong></div></td>
        </tr>
        <tr>
        ...
        <tr>
                ...
                <td style="width: 400px;"><div id="writer"><strong>${ searchData.writer}</strong></div></td>
        </tr>
 ...
 <table>
        <tr>
                <td>댓글</td>
                <td>
                <input type="text" name="reply" class="inputBox" style="width: 300px;">
                <input type="text" name="writer" class="inputBox" placeholder="작성자" >
                <input type="button" value="쓰기" class="btn" >
                <input type="hidden" name="num_ref" value="${param.num }" ><!--원글의 번호  -->
 ...
 <a href="#void" id="replyView">열기</a>
        <div id="reply">
                ...
                <div style="border: 1px solid #dfdfdf; width: 600px; margin-bottom: 3px; ">
                        <c:out value="${reply.content }"></c:out><br/>
                        <c:out value="${reply.writer }"></c:out>(<c:out value="${reply.input_date }"></c:out>)
                </div>
                </c:forEach>
        </div>
 </div>
